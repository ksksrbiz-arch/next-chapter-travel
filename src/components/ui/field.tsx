...
const base =
  "w-full rounded-xl border border-ink/20 bg-cream px-4 py-3 text-ink placeholder:text-stone/70 transition-colors focus:border-clay focus:outline-none focus:ring-2 focus:ring-clay/30";
